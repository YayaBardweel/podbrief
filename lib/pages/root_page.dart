...
class _RootPageState extends State<RootPage> {
    ...
    return Scaffold(
      ...
      body: NestedScrollView(
        ...
        body: PageView(
          ...
          physics:
              const NeverScrollableScrollPhysics(), // Keep this for tab switching
          onPageChanged: (i) => setState(() => _currentIndex = i),
          children: [
            // Ensure your tabs return scrollable widgets and have PageStorageKeys
            HomeTab(
                key: const PageStorageKey<String>('HomeTabScroll'),
                username: _username ?? 'User',
      ...
      bottomNavigationBar:
          CustomBottomNavBar(selectedIndex: _currentIndex, onTap: _onNavTapped),
    );
  }
  ...
  Widget _buildSliverAppBar(BuildContext context) {
    return SliverAppBar(
      ...
      backgroundColor:
          Colors.transparent, // Make SliverAppBar itself transparent
          ...
          child: Container(
            ...
            child: FlexibleSpaceBar(
              background: Container(
                  color: Colors
                      .transparent), // The actual background for the blur effect
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(
                              width: 8), // Space between search and avatar
                          CircleAvatar(
                            backgroundColor: Colors.white,
                            radius: 14,
                            child: Text(
